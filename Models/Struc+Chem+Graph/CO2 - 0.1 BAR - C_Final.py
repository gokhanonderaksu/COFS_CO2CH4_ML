...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group C/CO2 - 0.1 BAR - C.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0019362353594531653
exported_pipeline = make_pipeline(
    MaxAbsScaler(),
    RandomForestRegressor(bootstrap=True, max_features=0.55, min_samples_leaf=1, min_samples_split=7, n_estimators=100)
)
