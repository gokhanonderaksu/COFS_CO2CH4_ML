...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group C/CO2 - 10 BAR - C.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.7453024726961993
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=10, min_child_weight=15, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.7500000000000001, verbosity=0)
