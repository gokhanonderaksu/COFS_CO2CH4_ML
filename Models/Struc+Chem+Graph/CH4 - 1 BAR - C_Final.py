...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group C/CH4 - 1 BAR - C.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0029383098890282773
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=10, min_child_weight=17, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.5, verbosity=0)
