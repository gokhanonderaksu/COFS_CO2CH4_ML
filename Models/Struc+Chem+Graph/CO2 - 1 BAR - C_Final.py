...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group C/CO2 - 1 BAR - C.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.052096216966703704
exported_pipeline = RandomForestRegressor(bootstrap=False, max_features=0.25, min_samples_leaf=1, min_samples_split=3, n_estimators=100)
