...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group D/CO2 - 1 BAR - 393 K - D.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -2.149200301903394e-05
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=False, max_features=0.9500000000000001, min_samples_leaf=18, min_samples_split=4, n_estimators=100)),
...
X_unseen = pd.read_csv('C:/Users/WS01/Desktop/Github/Unseen Test Sheets/Unseen Label Sheets - Part1/hypoCOFUnseen-CO2 - D - 393 K - Part1 - 19050.csv', sep=',')
y_pred_unseen = exported_pipeline.predict(X_unseen)
df5 = pd.DataFrame(y_pred_unseen)
df5.to_csv('hypoCOFUnseen-CO2 - D - 298 K - Part1 - 19050.csv', index=False)
