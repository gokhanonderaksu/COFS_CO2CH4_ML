...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group D/CO2 - 10 BAR - D.csv', sep=',', dtype=np.float64)
features = tpot_data.drop('NCO2 at 10 bar (mol/kg)', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['NCO2 at 10 bar (mol/kg)'], random_state=42)
            
# Average CV score on the training set was: -0.379719795686723
exported_pipeline = make_pipeline(
    ZeroCount(),
    XGBRegressor(learning_rate=0.1, max_depth=7, min_child_weight=5, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.6500000000000001, verbosity=0)
)
...
X_unseen = pd.read_csv('C:/Users/WS01/Desktop/Github/Unseen Test Sheets/Unseen Label Sheets - Part1/hypoCOFUnseen-CO2 - D - 298 K - Part1 - 19050.csv', sep=',')
