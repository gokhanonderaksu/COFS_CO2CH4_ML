...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group D/CO2 - 1 BAR - D.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.010786558924105436
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=5, min_child_weight=2, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.5, verbosity=0)
