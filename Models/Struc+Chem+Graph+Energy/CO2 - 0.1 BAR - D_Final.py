...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group D/CO2 - 0.1 BAR - D.csv', sep=',', dtype=np.float64)
features = tpot_data.drop('NCO2 at 0.1 bar (mol/kg)', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['NCO2 at 0.1 bar (mol/kg)'], random_state=42)

# Average CV score on the training set was: -6.93959118489141e-05
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.9000000000000001, min_samples_leaf=1, min_samples_split=6, n_estimators=100)
