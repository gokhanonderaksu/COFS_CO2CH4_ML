...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group A/CO2 - 0.1 BAR - A.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0022218027709700527
exported_pipeline = make_pipeline(
    MaxAbsScaler(),
    RandomForestRegressor(bootstrap=False, max_features=0.15000000000000002, min_samples_leaf=1, min_samples_split=12, n_estimators=100)
)
