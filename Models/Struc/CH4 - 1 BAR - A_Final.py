...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group A/CH4 - 1 BAR - A.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.003956120316233958
exported_pipeline = make_pipeline(
    PolynomialFeatures(degree=2, include_bias=False, interaction_only=False),
    ExtraTreesRegressor(bootstrap=True, max_features=0.7500000000000001, min_samples_leaf=1, min_samples_split=6, n_estimators=100)
)
