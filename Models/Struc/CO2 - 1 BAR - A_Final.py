...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group A/CO2 - 1 BAR - A.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.061590295280299745
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.55, min_samples_leaf=1, min_samples_split=5, n_estimators=100)
