...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group A/CO2 - 10 BAR - A.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -1.2041382936624354
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.7500000000000001, min_samples_leaf=2, min_samples_split=2, n_estimators=100)
