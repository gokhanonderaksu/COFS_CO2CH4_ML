...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group A/CO2 - 1 BAR - 393 K - A.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.001178189643180868
exported_pipeline = RandomForestRegressor(bootstrap=True, max_features=0.7000000000000001, min_samples_leaf=2, min_samples_split=8, n_estimators=100)
