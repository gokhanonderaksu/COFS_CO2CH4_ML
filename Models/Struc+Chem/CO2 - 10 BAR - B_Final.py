...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group B/CO2 - 10 BAR - B.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.9185783952017674
exported_pipeline = make_pipeline(
    MaxAbsScaler(),
    XGBRegressor(learning_rate=0.1, max_depth=6, min_child_weight=4, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.6500000000000001, verbosity=0)
)
