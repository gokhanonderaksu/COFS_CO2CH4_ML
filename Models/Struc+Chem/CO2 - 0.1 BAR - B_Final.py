...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group B/CO2 - 0.1 BAR - B.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0020225900105771016
exported_pipeline = make_pipeline(
    MinMaxScaler(),
    RandomForestRegressor(bootstrap=False, max_features=0.3, min_samples_leaf=2, min_samples_split=2, n_estimators=100)
)
