...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group B/CH4 - 10 BAR - B.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.04543771519454878
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=9, min_child_weight=1, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.6000000000000001, verbosity=0)
