...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group B/CH4 - 1 BAR - B.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0032472862874471666
exported_pipeline = GradientBoostingRegressor(alpha=0.9, learning_rate=0.1, loss="huber", max_depth=7, max_features=0.6000000000000001, min_samples_leaf=6, min_samples_split=9, n_estimators=100, subsample=0.9000000000000001)
