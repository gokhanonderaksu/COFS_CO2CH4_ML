...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Original Excels/Group B/CO2 - 1 BAR - B.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.05603205240241051
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=RidgeCV()),
    ExtraTreesRegressor(bootstrap=True, max_features=0.7000000000000001, min_samples_leaf=2, min_samples_split=2, n_estimators=100)
)
