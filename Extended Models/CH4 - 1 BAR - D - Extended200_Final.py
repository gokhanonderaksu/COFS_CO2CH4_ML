...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Extended Excels/Group D - 200/CH4 - 1 BAR - D - Extended200.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0005993630083221928
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=5, min_child_weight=12, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.6000000000000001, verbosity=0)
...
X_unseen = pd.read_csv('C:/Users/WS01/Desktop/Github/Unseen Test Sheets/Unseen Label Sheets - Part2/hypoCOFUnseen-CH4 - D - 298 K - Part2 - 42K.csv', sep=',')
y_pred_unseen = exported_pipeline.predict(X_unseen)
df5 = pd.DataFrame(y_pred_unseen)
df5.to_csv('hypoCOFUnseen-CH4 - D - 298 K - Part2 - 42K.csv', index=False)
