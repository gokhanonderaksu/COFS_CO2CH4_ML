...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Extended Excels/Group D - 200/CO2 - 0.1 BAR - D - Extended200.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -7.543503245289309e-05
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.9000000000000001, min_samples_leaf=1, min_samples_split=10, n_estimators=100)
