...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Extended Excels/Group D - 200/CH4 - 10 BAR - D - Extended200.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.022366433292274734
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=10, min_child_weight=2, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.5, verbosity=0)
