...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Extended Excels/Group D - 200/CO2 - 1 BAR - 393 K - D - Extended200.csv', sep=',', dtype=np.float64)
features = tpot_data.drop('NCO2 at 1 bar-393 K (mol/kg)', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['NCO2 at 1 bar-393 K (mol/kg)'], random_state=42)

# Average CV score on the training set was: -3.904504367959956e-05
exported_pipeline = make_pipeline(
    MaxAbsScaler(),
    StackingEstimator(estimator=RandomForestRegressor(bootstrap=True, max_features=0.15000000000000002, min_samples_leaf=12, min_samples_split=13, n_estimators=100)),
    RidgeCV()
)
...
X_unseen = pd.read_csv('C:/Users/WS01/Desktop/Github/Unseen Test Sheets/Unseen Label Sheets - Part2/hypoCOFUnseen-CO2 - D - 393 K - Part2 - 42K.csv', sep=',')
y_pred_unseen = exported_pipeline.predict(X_unseen)
df5 = pd.DataFrame(y_pred_unseen)
df5.to_csv('hypoCOFUnseen-CO2 - D - 393 K - Part2 - 42K.csv', index=False)
