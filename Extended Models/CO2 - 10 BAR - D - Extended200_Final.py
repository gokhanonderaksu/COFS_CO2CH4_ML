...
tpot_data = pd.read_csv('C:/Users/WS01/Desktop/Github/Extended Excels/Group D - 200/CO2 - 10 BAR - D - Extended200.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.38601749489545495
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=6, min_child_weight=2, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.7000000000000001, verbosity=0)
